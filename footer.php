    ...
    <?php $footer_menu = wp_nav_menu( array(
        ...
        <div id="site-footer-top" class="clearfix">
	        ...
	        <div id="site-social">
				...
				<a title="Google Plus" id="site-googleplus" onclick="__gaTracker('send','event','outbound-footer-social','googleplus');" href="http://plus.google.com/+WashingtonUniversitySchoolofMedicineStLouis/"><img src="<?php echo get_template_directory_uri(); ?>/_/img/google-plus.svg" onerror="this.src='<?php echo get_template_directory_uri(); ?>/_/img/google-plus.png';this.onerror=null;"></a>
