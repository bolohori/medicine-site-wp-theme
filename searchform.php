<form name="search" method="get" id="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
    ...
    <div class="submit" name="submit" id="search-btn" onclick="document.getElementById('search-form').submit();"><img alt="Search" src="<?php echo get_template_directory_uri(); ?>/_/img/search.svg" onerror="this.src='<?php echo get_template_directory_uri(); ?>/_/img/search.png';this.onerror=null;"></div>
</form>