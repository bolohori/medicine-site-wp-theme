...
function queue_wusm_scripts() {
	...
	wp_enqueue_script('fitvids', get_stylesheet_directory_uri() . '/_/js/jquery.fitvids.js', array( 'jquery' ) );
    ...
    if ( strpos(get_page_template(), 'page-news.php') || get_the_title() == 'Campus Life' || is_singular( 'faculty_profile' ) ) {
